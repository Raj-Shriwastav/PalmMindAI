...
def install_reportlab_if_missing():
    try:
        ...
        print(
            "[INFO] 'reportlab' is missing. Installing reportlab to generate PDF files..."
        )
        import subprocess
...
def create_pdf_files():
    ...
    story2.append(
        Paragraph("PalmMind AI — Junior AI Engineer Hiring Track", title_style)
    )
    ...
    story2.append(
        Paragraph("Phase 3: Security, Hardening & Input Sanitization", h2_style)
    )
    story2.append(
        Paragraph(
