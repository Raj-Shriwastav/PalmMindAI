...
def verify_fastembed():
    ...
    print("Note: If this is the first time, FastEmbed will download the model weight (~400MB for Arctic) automatically.")
    ...
    try:
        ...
        print(f"[SUCCESS] Successfully generated embeddings in {embed_duration:.4f} seconds!")
